...
public class LottoMadness extends JFrame implements ItemListener {

    // set up row 1
    JPanel row1 = new JPanel();
    ButtonGroup option = new ButtonGroup();
    JCheckBox quickpick = new JCheckBox("Kombi", true);


    JCheckBox personal = new JCheckBox("Kombi", true);
    // set up row 2
    ...
    JTextField stop = new JTextField("Stop");
